...
ZEPHIR_INIT_FUNCS(snailroute_datagenerator_regexbasedabstract_method_entry) {
	PHP_ME(SnailRoute_DataGenerator_RegexBasedAbstract, getApproxChunkSize, NULL, ZEND_ACC_PROTECTED|ZEND_ACC_ABSTRACT)
	PHP_ME(SnailRoute_DataGenerator_RegexBasedAbstract, processChunk, arginfo_snailroute_datagenerator_regexbasedabstract_processchunk, ZEND_ACC_PROTECTED|ZEND_ACC_ABSTRACT)
