...
PHP_METHOD(SnailRoute_Dispatcher_GroupCountBased, __construct) {
	...
	zephir_array_fetch_long(&_0, data, 0, PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 8 TSRMLS_CC);
	zephir_update_property_this(this_ptr, SL("staticRouteMap"), _0 TSRMLS_CC);
	zephir_array_fetch_long(&_1, data, 1, PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 9 TSRMLS_CC);
...
PHP_METHOD(SnailRoute_Dispatcher_GroupCountBased, dispatchVariableRoute) {
	...
	array_init(vars);
	i = 0;
	zephir_is_iterable(routeData, &_1, &_0, 0, 0, "snailroute/Dispatcher/GroupCountBased.zep", 33);
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		zephir_array_fetch_string(&_4$$3, data, SL("regex"), PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 17 TSRMLS_CC);
		zephir_preg_match(_3$$3, _4$$3, uri, matches, 0, 0 , 0  TSRMLS_CC);
		if (!(zephir_is_true(_3$$3))) {
			continue;
		}
		zephir_array_fetch_string(&_5$$3, data, SL("routeMap"), PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 21 TSRMLS_CC);
		zephir_array_fetch_long(&matchedRoute, _5$$3, zephir_fast_count_int(matches TSRMLS_CC), PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 21 TSRMLS_CC);
		zephir_array_fetch_long(&handler, matchedRoute, 0, PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 22 TSRMLS_CC);
		zephir_array_fetch_long(&varNames, matchedRoute, 1, PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 23 TSRMLS_CC);
		zephir_is_iterable(varNames, &_7$$3, &_6$$3, 0, 0, "snailroute/Dispatcher/GroupCountBased.zep", 30);
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_7$$3, &_6$$3)
			...
			i = (i + 1);
			zephir_array_fetch_long(&_9$$5, matches, i, PH_NOISY | PH_READONLY, "snailroute/Dispatcher/GroupCountBased.zep", 27 TSRMLS_CC);
